  ...
  if (thunar_view_get_loading (THUNAR_VIEW (standard_view)))
  ...
  else
    {
      ...
      if (G_LIKELY (paths != NULL))
        ...
        {
          /* If the path was not found, it most likely is a new file which was just added */
          thunar_standard_view_new_files (standard_view, selected_files);
        }
    }
}
...
thunar_standard_view_context_menu (ThunarStandardView *standard_view)
{
  ...
  context_menu = g_object_new (THUNAR_TYPE_MENU, "launcher", thunar_window_get_launcher (THUNAR_WINDOW (window)), NULL);
...
void
thunar_standard_view_append_menu_items (ThunarStandardView *standard_view, GtkMenu *menu, GtkAccelGroup *accel_group)
{
  _thunar_return_if_fail (THUNAR_IS_STANDARD_VIEW (standard_view));
...
void
thunar_standard_view_append_accelerators  (ThunarStandardView *standard_view, GtkAccelGroup *accel_group)
{
  _thunar_return_if_fail (THUNAR_IS_STANDARD_VIEW (standard_view));
