                            ...
                            GClosure          *new_files_closure)
{
  ...
  /* launch the operation */
  thunar_application_launch (application, parent, "thunar-folder-copy-symbolic",
                              ...
                              GClosure          *new_files_closure)
{
  ...
  thunar_application_collect_and_launch (application, parent, "thunar-folder-copy-symbolic",
  ...
  if (thunar_g_file_is_trashed (target_file))
  ...
  else
    {
      ...
      thunar_application_collect_and_launch (application, parent,
                                             "thunar-folder-move-symbolic", title,
                                  ...
                                  GClosure          *new_files_closure)
{
  ...
  if (G_UNLIKELY (err != NULL))
    ...
    {
      /* launch the operation */
      thunar_application_launch (application, parent, "thunar-folder-move-symbolic",
