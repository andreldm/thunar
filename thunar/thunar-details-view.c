...
static void         thunar_details_view_append_accelerators     (ThunarStandardView     *standard_view,
...
static void
thunar_details_view_append_accelerators  (ThunarStandardView *standard_view,
                                          GtkAccelGroup      *accel_group)
{
                                       ...
                                       GtkAccelGroup      *accel_group)
{
  ...
  thunar_gtk_menu_item_new_from_action_entry (get_action_entry (THUNAR_DETAILS_VIEW_ACTION_CONFIGURE_COLUMNS), G_OBJECT (details_view), TRUE, TRUE, GTK_MENU_SHELL (menu));
}
